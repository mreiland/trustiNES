...
pub fn load_from_file<P:AsRef<Path>>(file_path: P) -> Result<(HashMap<u16,OpcodeExecInfo>,HashMap<u16,OpcodeDebugInfo>),OpcodeLoadError> {
    ...
    let mut exec_info_hash = HashMap::<u16,OpcodeExecInfo>::new();
    let mut debug_info_hash = HashMap::<u16,OpcodeDebugInfo>::new();
